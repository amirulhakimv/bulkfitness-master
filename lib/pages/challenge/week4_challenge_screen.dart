...
class Week4ChallengeScreen extends StatefulWidget {
  const Week4ChallengeScreen({super.key});

  @override
  State<Week4ChallengeScreen> createState() => _Week4ChallengeScreenState();
}

class _Week4ChallengeScreenState extends State<Week4ChallengeScreen> {
  Timer? _timer;
  Duration _remainingTime = Duration(minutes: 55); // Set initial time here
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const WorkoutWidget(title: 'Push-ups', subTitle: '4 sets . 15-20 reps', image: 'lib/images/push_ups.png'),
                    const WorkoutWidget(title: 'Squats Jump', subTitle: '4 sets . 15 reps', image: 'lib/images/squats.png'),
                    const WorkoutWidget(title: 'Planks', subTitle: '4 sets . 45-60 seconds reps', image: 'lib/images/planks.png'),
                    const WorkoutWidget(title: 'Dumbbell Rows', subTitle: '4 sets . 15 reps', image: 'lib/images/dumble_row.png'),
                    const WorkoutWidget(
                        title: 'Lunges (with Dumbbells)', subTitle: '4 sets . 12-15 per leg reps', image: 'lib/images/jump_squat.png'),
                  ],
                ),
              ),
            ],
