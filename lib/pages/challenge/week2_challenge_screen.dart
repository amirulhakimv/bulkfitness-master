...
class Week2ChallengeScreen extends StatefulWidget {
  const Week2ChallengeScreen({super.key});

  @override
  State<Week2ChallengeScreen> createState() => _Week2ChallengeScreenState();
}

class _Week2ChallengeScreenState extends State<Week2ChallengeScreen> {
  Timer? _timer;
  Duration _remainingTime = Duration(minutes: 35); // Set initial time here
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const WorkoutWidget(title: 'Push-ups', subTitle: '4 sets . 10-12 reps', image: 'lib/images/push_ups.png'),
                    const WorkoutWidget(title: 'Squats', subTitle: '4 sets . 15 reps', image: 'lib/images/squats.png'),
                    const WorkoutWidget(title: 'Planks', subTitle: '4 sets . 30-40 seconds reps', image: 'lib/images/planks.png'),
                    const WorkoutWidget(title: 'Dumbbell Rows', subTitle: '4 sets . 12 reps', image: 'lib/images/dumble_row.png'),
                    const WorkoutWidget(title: 'Lunges', subTitle: '4 sets . 12 per leg reps', image: 'lib/images/lungs.png'),
                  ],
                ),
              ),
            ],
